  ...
  -->
    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            <!--  End price list PART  ------------>
            {{-- clients --}}
            <li class="nav-item {{ $activePage == 'all-clients' || $activePage == 'createclient' || $activePage == 'edit-clients' || $activePage == 'show-clients' || $activePage == 'createclientWalletTransaction' || $activePage == 'walletclientTransaction' || $activePage == 'editclientwalletTransaction' || $activePage == 'showwalletclientTransaction' || $activePage == 'wallet-clients' ? ' active' : '' }}">
                ...
                <div class="collapse{{ $activePage == 'all-clients' || $activePage == 'createclient' || $activePage == 'edit-clients' || $activePage == 'show-clients' || $activePage == 'createclientWalletTransaction' || $activePage == 'walletclientTransaction' || $activePage == 'editclientwalletTransaction' || $activePage == 'showwalletclientTransaction' || $activePage == 'wallet-clients' ? ' show' : '' }} " id="clients">
                    <ul class="nav">
            ...
            <li class="nav-item ml-3 {{ $activePage == 'wallet-clients' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('get.client.wallet') }}">
                    <i class="fa fa-credit-card-alt {{ $activePage == 'wallet-clients' ? 'text-light' : 'text-dark' }} " aria-hidden="true"></i>
    ...
    <li class="nav-item {{ $activePage == 'all-suppliers' || $activePage == 'createsupplier' || $activePage == 'edit-suppliers' || $activePage == 'show-suppliers' || $activePage == 'wallet-suppliers' || $activePage == 'createSupplierWalletTransaction' || $activePage == 'walletsupplierTransaction' || $activePage == 'editwalletTransaction' || $activePage == 'showwalletsupplierTransaction' || $activePage == 'createpricelist' || $activePage == 'allpricelists' || $activePage == 'editpricelist' ? ' active' : '' }}">
        ...
        <div class="collapse{{ $activePage == 'all-suppliers' || $activePage == 'createsupplier' || $activePage == 'edit-suppliers' || $activePage == 'show-suppliers' || $activePage == 'wallet-suppliers' || $activePage == 'createSupplierWalletTransaction' || $activePage == 'walletsupplierTransaction' || $activePage == 'editwalletTransaction' || $activePage == 'showwalletsupplierTransaction' || $activePage == 'createpricelist' || $activePage == 'allpricelists' || $activePage == 'editpricelist' ? ' show' : '' }} " id="suppliers">
            <ul class="nav">
    ...
    {{-- price list --}}
    <li class="nav-item ml-3 {{ $activePage == 'createpricelist' || $activePage == 'allpricelists' || $activePage == 'editpricelist' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('priceLists.index') }}">
            <i class="fa fa-th-list {{ $activePage == 'createpricelist' || $activePage == 'allpricelists' || $activePage == 'editpricelist' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
            {{ __('translation.website.sidebar.All Price Lists') }}
        </a>
    </li>
    {{-- supplier Wallet --}}
    <li class="nav-item ml-3{{ $activePage == 'wallet-suppliers' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('get.supplier.wallet') }}">
            <i class="fa fa-credit-card-alt  {{ $activePage == 'wallet-suppliers' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
...
{{-- Roles --}}
<li class="nav-item ml-3 {{ $activePage == 'allRoles' || $activePage == 'createRole' || $activePage == 'editRole' ? ' active' : '' }}">
    <a class="nav-link" href="{{ route('roles.index') }}">
        <i class="fa fa-briefcase  {{ $activePage == 'allRoles' || $activePage == 'createRole' || $activePage == 'editRole' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
        {{ __('translation.website.sidebar.All Roles') }}
    </a>
</li>
{{-- Permissions --}}
<li class="nav-item ml-3 {{ $activePage == 'allPermissions' || $activePage == 'createPermission' || $activePage == 'editPermission' ? ' active' : '' }}">
    <a class="nav-link" href="{{ route('permissions.index') }}">
        <i class="fa fa-exclamation-triangle  {{ $activePage == 'allPermissions' || $activePage == 'createPermission' || $activePage == 'editPermission' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
...
<li class="nav-item ml-3 {{ $activePage == 'wallet-users' ? ' active' : '' }}">
    <a class="nav-link" href="{{ route('get.user.wallet') }}">
        <i class="fa fa-credit-card-alt {{ $activePage == 'wallet-users' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
...
<!--  Start expenses PART  -------->
{{-- expenses --}}
<li class="nav-item {{ $activePage == 'addExpense' || $activePage == 'allExpense' || $activePage == 'editexpense' || $activePage == 'createexpensetype' || $activePage == 'allexpensestypes' || $activePage == 'editexpensetype' ? ' active' : '' }}">
    ...
    <div class="collapse {{ $activePage == 'addExpense' || $activePage == 'allExpense' || $activePage == 'editexpense' || $activePage == 'createexpensetype' || $activePage == 'allexpensestypes' || $activePage == 'editexpensetype' ? ' show' : '' }} " id="expenses">
        <ul class="nav">
...
{{-- reports --}}
<li class="nav-item {{
                 $activePage == 'mostSaleProducts' ||
                $activePage == 'monthlyProfits' || 
                $activePage == 'totalCapital'|| 
                $activePage == 'bestCustomers'||
                $activePage == 'bestSuppliers'||
                $activePage == 'frquentcustomers'||
                $activePage == 'frquentSuppliers'||
                $activePage == 'installmentandsales'||
                $activePage == 'installmentandpurchases'||
                $activePage == 'receivablesandpayments'
                ? ' active' : '' }}">
        ...
        <ul class="nav">
            <li class="nav-item ml-3 {{ $activePage == 'mostSaleProducts' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('most-sold-products') }}">
                    <i class="fa fa-line-chart {{ $activePage == 'mostSaleProducts' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
            ...
            <li class="nav-item ml-3 {{ $activePage == 'monthlyProfits' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('monthly-profits') }}">
                    <i class="fa fa-line-chart {{ $activePage == 'monthlyProfits' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
            ...
            <li class="nav-item ml-3 {{ $activePage == 'totalCapital' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('total-capital') }}">
                    <i class="fa fa-line-chart {{ $activePage == 'totalCapital' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
            ...
            <li class="nav-item ml-3 {{ $activePage == 'bestCustomers' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('best-customers') }}">
                    <i class="fa fa-line-chart {{ $activePage == 'bestCustomers' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
            ...
            <li class="nav-item ml-3 {{ $activePage == 'bestSuppliers' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('best-suppliers') }}">
                    <i class="fa fa-line-chart {{ $activePage == 'bestSuppliers' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
            ...
            <li class="nav-item ml-3 {{ $activePage == 'frquentcustomers' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('frequent-customers') }}">
                    <i class="fa fa-line-chart {{ $activePage == 'frquentcustomers' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
            ...
            <li class="nav-item ml-3 {{ $activePage == 'frquentSuppliers' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('frequent-suppliers') }}">
                    <i class="fa fa-line-chart {{ $activePage == 'frquentSuppliers' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
            ...
            <li class="nav-item ml-3 {{ $activePage == 'installmentandsales' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('Installments-and-sales') }}">
                    <i class="fa fa-line-chart {{ $activePage == 'installmentandsales' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
            ...
            <li class="nav-item ml-3 {{ $activePage == 'installmentandpurchases' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('installments-and-purchases') }}">
                    <i class="fa fa-line-chart {{ $activePage == 'installmentandpurchases' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
            ...
            <li class="nav-item ml-3 {{ $activePage == 'receivablesandpayments' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('receivables-and-payments') }}">
                    <i class="fa fa-line-chart {{ $activePage == 'receivablesandpayments' ? 'text-light' : 'text-dark' }}" aria-hidden="true"></i>
