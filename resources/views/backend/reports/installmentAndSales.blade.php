@extends('layouts.app', ['activePage' => 'installmentandsales', 'titlePage' => __('translation.website.sidebar.installment and sales')])
                    ...
                    <div class="row">
                        <div class="col-xl">
                            <div class="card-header card-header-text card-header-info">
                                <div class="card-text">
                                    <h4 class="card-title ">{{__('translation.website.sidebar.installment and sales')}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table ">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">{{__('translation.reports.Total number of sales')}}</th>
