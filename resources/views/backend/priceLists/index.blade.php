@extends('layouts.app', ['activePage' => 'allpricelists', 'titlePage' => __('translation.website.sidebar.All Price Lists')])
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12 text-right">
                                <a href="{{ route('priceLists.create') }}" class="btn btn-round btn-primary mb-3" style="color:white;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-actions">
                                            ...
                                            <a class="btn btn-primary" rel="tooltip" href="#" title="{{__('translation.pricelists.Show Price List')}}" style="color:white;"><i class='fa fa-eye'></i></a>
                                            ...
                                            <form method="post" action="{{ route('priceLists.destroy', 5) }}" style="display:none;" id="delete-1">
                                                @csrf
                                                @method('delete')
                                            </form>
                                        </td>
