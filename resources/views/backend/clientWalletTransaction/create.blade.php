            ...
            <div class="col-md-12">
                <div class="col-md-12">
                    <div class="card card-mode">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="form-group" style="margin: 20px;">
                                    <p class="font-weight-bold"  for="inputAddress">{{ __('translation.walletTransaction.Reason') }}</p>
                                    <input type="text" name="reason" class="form-control" id="inputAddress" required placeholder="Please enter transaction reason">
                                </div>

                                <div class="form-group" style="margin: 20px;">
                                    <p class="font-weight-bold" name="client_name"  for="selUser" f>{{ __('translation.clients.Client Name') }}</p>
                        ...
                        <div class="form-group" style="margin: 20px;">
                            <p class="font-weight-bold"  for="inputAddress">{{ __('translation.walletTransaction.Date') }}</p>
                            <input type="date" name="date" class="form-control" id="inputAddress" required placeholder="please choose transaction date">
                        </div>

                        <div class="form-group" style="margin: 20px;">
                            <p class="font-weight-bold"  for="selTrans">{{ __('translation.walletTransaction.Transaction') }}</p>
                        ...
                        <div class="form-group" style="margin: 20px;">
                            <p class="font-weight-bold"  for="selTransType">{{ __('translation.walletTransaction.Transaction Type') }}</p>
                        ...
                        <div class="form-group" style="margin: 20px;">
                            <p class="font-weight-bold"  for="inputAddress">{{ __('translation.walletTransaction.Amount') }}</p>
