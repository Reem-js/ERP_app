@extends('layouts.app', ['activePage' => 'all-suppliers', 'titlePage' => __('translation.website.sidebar.all Suppliers')])
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="{{ route('suppliers.create') }}" rel="tooltip" title="{{ __('translation.title.create Supplier') }}"  class="btn btn-primary btn-round"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="td-actions">
                                            ...
                                            <a class="btn btn-danger" rel="tooltip" title="{{ __('translation.title.Delete Supplier') }}"
