                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <p class="card-category" style="font-weight:400; color:black ">{{__('translation.website info.Website Name')}}</p>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <p class="card-category" style="font-weight:400; color:black ">{{__('translation.website info.Website Phone')}}</p>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <p class="card-category" style="font-weight:400; color:black ">{{__('translation.website info.Preffered Langauge')}}</p>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <p class="card-category" style="font-weight:400; color:black ">{{__('translation.website info.Teams')}}</p>
                                <select class="form-group form-control " style="width: 100%;">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <p class="card-category" style="font-weight:400; color:black ">{{__('translation.website info.Product translation')}}</p>
                                <select class="form-group form-control " style="width: 100%;">
                                    <option value="1">{{__('translation.website.crud.Yes')}}</option>
                                    <option value="0">{{__('translation.website.crud.No')}}</option>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <p class="card-category" style="font-weight:400; color:black ">{{__('translation.website info.Website Logo')}}</p>
