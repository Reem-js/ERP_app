                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <div class="text-danger" data-toggle="modal" data-target="#exampleModalLong">Open Modal</div>
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{{ __('translation.purchase.type') }}</th>
                                                        <th>{{ __('translation.purchase.total cost') }}</th>
                                                        <th>{{ __('translation.purchase.paid') }}</th>
                                                        <th>{{ __('translation.purchase.residual') }}</th>
                                                        <th>{{ __('translation.purchase.Actions') }}</th>
