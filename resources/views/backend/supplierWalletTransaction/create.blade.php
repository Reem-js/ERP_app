@extends('layouts.app', ['activePage' => 'createSupplierWalletTransaction', 'titlePage' => __('translation.suppliers.common.Add New Supplier-Transaction')])
@section('content')
    <div class="content">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-text card-header-primary">
                                <div class="card-text">
                                    <h4 class="card-title">{{ __("translation.suppliers.common.Add New Supplier-Transaction") }}</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <form>
