@extends('layouts.app', ['activePage' => 'walletsupplierTransaction', 'titlePage' => __('translation.suppliers.common.Supplier Wallet Transaction')])
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-text card-header-primary">
                            <div class="card-text">
                                <h4 class="card-title">{{ __('translation.suppliers.common.Supplier Wallet Transaction') }}</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <a href="{{ route('supplier-wallet-transactions.create') }}" class="btn btn-success btn-round"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-actions">
                                            ...
                                            <a class="btn btn-warning" href="{{ route('supplier-wallet-transactions.edit', 5) }}"
